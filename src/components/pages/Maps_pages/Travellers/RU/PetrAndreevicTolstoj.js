...
function TravellerPage() {
  ...
  return (
    ...
    <Breadcrumb>
        ...
        <Breadcrumb.Item active>Pëtr Andreevič Tolstoj</Breadcrumb.Item>
    </Breadcrumb>
      <h1>Pëtr Andreevič Tolstoj</h1>
      <img src={tolstoj} className='traveller-page'></img>
      <div className='traveller-description'>
        <p><strong>Nationality</strong>: {t('travellers.ru_nationality')}</p>
        <p><strong>Lifetime</strong>: 1645-1729</p>
        <p><strong>Occupation</strong>: {t('travellers.ru_Tolstoj_occupation')}</p>
        {/*<p><strong>Visited Bologna in</strong>: 0000/something century</p>*/}
        <p dangerouslySetInnerHTML={{ __html: t('travellers.ru_Tolstoj_text')}}></p>
        <h4>Fragments</h4>
