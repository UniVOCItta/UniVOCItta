  ...
  return (
    ...
    <Breadcrumb>
      ...
      <div className='traveller-description'>
        ...
        <p><strong>Lifetime</strong>: 1822-1896 - 1830-1870</p>
        <p><strong>Occupation</strong>: {t('travellers.fr_Goncourt_occupation')}</p>
        {/*<p><strong>Visited Bologna in</strong>: 0000/something century</p>*/}
        <p dangerouslySetInnerHTML={{ __html: t('travellers.fr_Goncourt_text')}}></p>
        <h4>Fragments</h4>
