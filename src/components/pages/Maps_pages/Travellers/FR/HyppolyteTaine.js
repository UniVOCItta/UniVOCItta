...
function TravellerPage() {
  return (
    ...
    <Breadcrumb>
        ...
        <Breadcrumb.Item active>Hyppolite Taine</Breadcrumb.Item>
    </Breadcrumb>
      <h1>Hyppolite Taine</h1>
      <img src={taine} className='traveller-page'></img>
      <div className='traveller-description'>
        <p><strong>Nationality</strong>: French</p>
        <p><strong>Lifetime</strong>: 1828-1893</p>
        <p><strong>Occupation</strong>: ...</p>
        <p><strong>Visited Bologna in</strong>: 0000/something century</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum [<HashLink to='https://fr.wikipedia.org/wiki/Hippolyte_Taine'>Wikipedia</HashLink>]</p>
        <h4>Fragments</h4>
