...
function TravellerPage() {
  ...
  return (
    ...
    <Breadcrumb>
        ...
        <Breadcrumb.Item active>Joseph Addison</Breadcrumb.Item>
    </Breadcrumb>
      <h1>Joseph Addison</h1>
      <img src={addison} className='traveller-page'></img>
      <div className='traveller-description'>
        <p><strong>Nationality</strong>: {t('travellers.en_nationality')}</p>
        <p><strong>Lifetime</strong>: 1672-1719</p>
        <p><strong>Occupation</strong>: {t('travellers.en_Addison_occupation')}</p>
        <p><strong>Visited Bologna in</strong>: 0000/something century</p>
        <p dangerouslySetInnerHTML={{ __html: t('travellers.en_Addison_text')}}></p>
        <h4>Fragments</h4>
