...
function TravellerPage() {
  ...
  return (
    ...
    <Breadcrumb>
        ...
        <Breadcrumb.Item active>Pío Baroja</Breadcrumb.Item>
    </Breadcrumb>
      <h1>Pío Baroja</h1>
      ...
      <div className='traveller-description'>
        ...
        <p><strong>Lifetime</strong>: 1872-1956</p>
        <p><strong>Occupation</strong>: {t('travellers.es_Baroja_occupation')}</p>
        {/*<p><strong>Visited Bologna in</strong>: 0000/something century</p>*/}
        <p dangerouslySetInnerHTML={{ __html: t('travellers.es_Baroja_text')}}></p>
        <h4>Fragments</h4>
