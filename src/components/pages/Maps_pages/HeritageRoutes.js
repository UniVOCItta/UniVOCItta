...
const HeritageRoutes = () => {
  ...
  const routes =  [
    ...
    },
    {
      id: 5,
      category: "Museum",
      title: t('routes.museum'),
      time: "35min",
      km: "2,4km",
      path: t('maps.easy'),
      text: t("routes.museum_text"),
